...
// and pb_public/js/foundation.esm.js (ES module). Both are committed artifacts;
// CI fails if they drift from a fresh build. Pass --watch for rebuild-on-change.
...
function checkSize() {
  for (const b of builds) {
    ...
    if (gzipped > MAX_GZIP_BYTES) {
      console.error(`${label} exceeds the ${MAX_GZIP_BYTES / 1024}KB gzipped budget`)
      process.exitCode = 1
    }
  }
}
